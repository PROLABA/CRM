...
import {A_CREATE, A_DELETE, A_GET_LIST, A_UPDATE, HLBL_ID_Order, R_HLBL} from "@/store/constants.ts";
...
export const deleteOrderByIDThank = mainThank<I_Order>(`${R_HLBL}/${HLBL_ID_Order}${A_DELETE}`, "DELETE");
