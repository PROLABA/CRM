...
import {A_CREATE, A_DELETE, A_GET_LIST, A_UPDATE, HLBL_ID_OrderOffers, R_HLBL} from "@/store/constants.ts";
...
export const deleteOrderOfferByIDThank = mainThank<I_OrderOffers>(`${R_HLBL}/${HLBL_ID_OrderOffers}${A_DELETE}`, "DELETE");
